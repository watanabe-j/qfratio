...
Note that the [GNU Scientific Library](https://www.gnu.org/software/gsl/)
(`GSL`) needs to be installed separately to use `RcppGSL`.
It seems that Windows users with a recent version of `Rtools` can skip
this installation.
