...
This version bundles relevant files from the
[GNU Scientific Library](https://www.gnu.org/software/gsl/),
so that it does not need to be installed separately.
...
This package bundles selected `C` codes from `GSL`, whose copyright belongs to
