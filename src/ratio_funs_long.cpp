...
// //'
// // [[Rcpp::export]]
// SEXP ApIq_npi_nvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> UA, const long double b1,
//                   const Eigen::Vector<long double, Eigen::Dynamic> mu,
...
//     ArrayXXl dks = h2_ij_vE(LAh, ArrayXl::Zero(n), mud, m, lscf);
...
// //'
// // [[Rcpp::export]]
// SEXP ApBq_npi_cvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
...
// //'
// // [[Rcpp::export]]
// SEXP ApBq_npi_cmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                   const long double b1, const long double b2,
//                   const long double p = 1, const long double q = 1,
//                   const int m = 100, bool error_bound = false) {
//     const int n = LB.size();
...
// //'
// // [[Rcpp::export]]
// SEXP ApBq_npi_nvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                   const long double b1, const long double b2, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                   const long double p = 1, const long double q = 1,
//                   const int m = 100, bool error_bound = false) {
//     const int n = LB.size();
//     const long double n_ = n;
...
// //'
// // [[Rcpp::export]]
// SEXP ApBq_npi_nmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                   const long double b1, const long double b2, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                   const long double p = 1, const long double q = 1,
//                   const int m = 100, bool error_bound = false) {
//     const int n = LB.size();
...
// //'
// // [[Rcpp::export]]
// SEXP ApBIqr_int_nvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const long double b2, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
...
//         long double dp = dtil1_i_vE(LAp / LB / b2, mub, int(p), lscfdp)(p);
//         long double lBdet = log(LB * b2).sum();
//         ArrayXl lcoefe =
//             ArrayXl::LinSpaced(m + 1, s + 1, s + m + 1).lgamma() - lgamma(s) -
//             ArrayXl::LinSpaced(m + 1, n_ / 2 + p + 1, n_ / 2 + p + m + 1).lgamma() +
//             lgamma(n_ / 2 + p - q - r);
...
// //'
// // [[Rcpp::export]]
// SEXP ApBIqr_int_nmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LA,
//                     const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> UA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const long double b2, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
...
//         ArrayXl lscfdp = ArrayXl::Zero(p + 1);
//         long double dp = dtil1_i_mE(Bisqr * Ap * Bisqr / b2, mub, int(p), lscfdp)(p);
//         long double lBdet = log(LB * b2).sum();
//         ArrayXl lcoefe =
//             ArrayXl::LinSpaced(m + 1, s + 1, s + m + 1).lgamma() - lgamma(s) -
//             ArrayXl::LinSpaced(m + 1, n_ / 2 + p + 1, n_ / 2 + p + m + 1).lgamma() +
...
// //'
// // [[Rcpp::export]]
// SEXP ApBIqr_npi_cvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const long double b1, const long double b2,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
//                     const int m = 100) {
//     const int n = LB.size();
...
// //'
// // [[Rcpp::export]]
// SEXP ApBIqr_npi_cmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const long double b1, const long double b2,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
//                     const int m = 100) {
//     const int n = LB.size();
...
// //'
// // [[Rcpp::export]]
// SEXP ApBIqr_npi_nvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const long double b1, const long double b2, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
...
// //'
// // [[Rcpp::export]]
// SEXP ApBIqr_npi_nmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const long double b1, const long double b2, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
...
// //'
// // [[Rcpp::export]]
// SEXP IpBDqr_gen_cvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LB, const Eigen::Array<long double, Eigen::Dynamic, 1> LD,
...
// //'
// // [[Rcpp::export]]
// SEXP IpBDqr_gen_cmEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LB, const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> D,
//                     const long double b2, const long double b3,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
//                     const int m = 100) {
//     const int n = LB.size();
...
// //'
// // [[Rcpp::export]]
// SEXP IpBDqr_gen_nvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LB, const Eigen::Array<long double, Eigen::Dynamic, 1> LD,
...
// //'
// // [[Rcpp::export]]
// SEXP IpBDqr_gen_nmEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LB, const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> D,
//                     const long double b2, const long double b3, const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
//                     const int m = 100, int nthreads = 0) {
//     const int n = LB.size();
...
// //'
// // [[Rcpp::export]]
// SEXP ApBDqr_int_nvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const Eigen::Array<long double, Eigen::Dynamic, 1> LD,
//                     const long double b2, const long double b3,
...
// //'
// // [[Rcpp::export]]
// SEXP ApBDqr_int_nmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> D,
//                     const long double b2, const long double b3,
//                     const Eigen::Array<long double, Eigen::Dynamic, 1> mu,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
...
// //'
// // [[Rcpp::export]]
// SEXP ApBDqr_npi_cvEl(const Eigen::Array<long double, Eigen::Dynamic, 1> LA, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const Eigen::Array<long double, Eigen::Dynamic, 1> LD,
...
// //'
// // [[Rcpp::export]]
// SEXP ApBDqr_npi_cmEl(const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> A, const Eigen::Array<long double, Eigen::Dynamic, 1> LB,
//                     const Eigen::Matrix<long double, Eigen::Dynamic, Eigen::Dynamic> D,
//                     const long double b1, const long double b2, const long double b3,
//                     const long double p = 1, const long double q = 1, const long double r = 1,
//                     const int m = 100, int nthreads = 0) {
